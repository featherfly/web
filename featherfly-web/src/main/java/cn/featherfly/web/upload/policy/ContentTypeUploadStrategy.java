 ...
 * @author 钟冀
 */
public class ContentTypeUploadStrategy extends AbstractWhiteBlackListUploadStrategy {

    private static final Logger LOGGER = LoggerFactory
        .getLogger(ContentTypeUploadStrategy.class);

    /**
     *
     */
    public ContentTypeUploadStrategy() {
